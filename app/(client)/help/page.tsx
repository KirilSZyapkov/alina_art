    ...
    const faqs = [
        {
            ...
            answer: "Всички произведения са достъпни в нашата галерия. Можете да филтрирате по категория, стил или техника за по-лесно намиране."
        },
        {
            question: "Как да поръчам произведение?",
            answer: "Изберете желаното произведение, кликнете на 'Поръчай' и следвайте указанията за плащане. Ще получите потвърждение по имейл."
        },
        {
            question: "Какво е времето на доставка?",
            answer: "Обичайно време на доставка е 7-14 работни дни, в зависимост от сложността и вида на поръчката."
        },
        {
